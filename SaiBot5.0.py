...
class Map(qtw.QGraphicsScene):
    def __init__(self, parent=None):
        ...
        try:
            ...
            np.savetxt('mapData.csv', self.mapData, delimiter=',')
    ...
    def __addPath(self):
        ...
        # most recent tile selection will be the end of the path
        end = ((self.__selected[-1][1] // 10), (self.__selected[-1][0] // 10))
        start = ((self.__selected[-2][1] // 10), (self.__selected[-2][0] // 10))
